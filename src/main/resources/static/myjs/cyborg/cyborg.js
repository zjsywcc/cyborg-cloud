        ...
        "aoColumns" : [
            ...
            {"mDataProp":"id" ,"bVisible": true,
                'fnRender' : function(oObj, sVal) {
                    ...
                    toolcol = toolcol +		'</a></shiro:hasPermission>';
                    toolcol = toolcol + '<shiro:hasPermission name="alarm:monitor"><a class="black" href="../monitor/index.html#'+sVal+'">';
                    toolcol = toolcol +'<i class=" fa fa-stethoscope"></i>'
                    toolcol = toolcol +		'</a></shiro:hasPermission>';
                    toolcol = toolcol + '<shiro:hasPermission name="alarm:monitor"><a class="black" href="javascript:pushInfo(\''+sVal+'\',\''+oObj.aData.name+'\')">';
                    toolcol = toolcol +'<i class="fa fa-bell" aria-hidden="true"></i>'
                    toolcol = toolcol +		'</a></shiro:hasPermission>';
                    toolcol = toolcol +	'</div>';
...
function editInfo(id) {
    ...
    function pushInfo(id,name) {
        $("#push_id").attr("value",id);
        $("#push_name").attr("value",name);
    ...
    function pushOk() {
            ...
            $("#push_form").ajaxForm(option).submit();
