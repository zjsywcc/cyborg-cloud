...
function initGroup(){
    oTable1 = $('#datatable').dataTable({
        ...
        "aoColumns" : [
            ...
            {"mDataProp":"result" ,"bVisible": true, "sDefaultContent": '<span class="label label-warning">未定义</span>',
            ...
            {"mDataProp":"terminology" ,"bVisible": true, "sDefaultContent": ""},
    ...
    $.ajax({
        ...
        success : function(e) {
            ...
            if(e.code == 0){
                ...
                $("#edit_terminology").attr("value",obj.terminology);
                $("#picWithIDCard").html('');
