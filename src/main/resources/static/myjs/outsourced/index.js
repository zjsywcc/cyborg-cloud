...
function initGroup(){
    oTable1 = $('#datatable').dataTable({
        ...
        "aoColumns" : [
            ...
            {"mDataProp":"contentor" ,"bVisible": true},
            {"mDataProp":"address" ,"bVisible": true},
            {"mDataProp":"scale" ,"bVisible": true},
            {"mDataProp":"license" ,"bVisible": true},
    ...
    $.ajax({
        ...
        success : function(e) {
            ...
            if(e.code == 0){
                ...
                $("#edit_address").attr("value",obj.address);
                $("#edit_contentor").attr("value",obj.contentor);
                $("#edit_tel").attr("value",obj.tel);
                $("#edit_companyLicense").val(obj.companyLicense);
                $("#edit_companyScale").val(obj.companyScale);
