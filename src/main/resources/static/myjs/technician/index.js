            ...
            {"mDataProp":"company" ,"bVisible": true,
                "fnRender":function (oObj, sVal) {
                    for(var i=0;i<allcompany.length;i++){
                        ...
                        if(allcompany[i].id == sVal){
                            return allcompany[i].name;
                        }
    ...
    $.ajax({
        ...
        success : function(e) {
            ...
            if(e.code == 0){
                ...
                $("#edit_sex").attr("value",obj.sex);
                $("#edit_phone").attr("value",obj.mphone);
                $("#edit_wechat").attr("value",obj.wechat);
                $("#edit_email").attr("value",obj.email);
                $("#edit_type").val(obj.type);
                $("#edit_company").val(obj.companyId);
                $("#edit_remark").val(obj.remarks);
    ...
    $.ajax({
        ...
        success : function(e) {
            ...
            if(e.code == 0){
                ...
                //在添加和修改对话框中显示
                for(var i=0;i<allcompany.length;i++){
                    var html = "<option value='"+allcompany[i].id+"'>"+allcompany[i].name+"</option>";
                    $("#add_company").append(html);
                    $("#edit_company").append(html);
